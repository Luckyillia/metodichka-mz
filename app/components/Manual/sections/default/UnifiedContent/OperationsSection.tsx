...
const OperationsSection: React.FC<OperationsSectionProps> = ({ gender }) => {
    ...
    const adaptTextForGender = (text: string): string => {
        if (gender === 'female') {
            return text
                ...
                .replace(/накрыл/g, 'накрыла')
                .replace(/подсоединил/g, 'подсоединила')
                .replace(/помог/g, 'помогла')
                .replace(/потянул/g, 'потянула')
                .replace(/проверил/g, 'проверила')
                .replace(/обернул/g, 'обернула')
                .replace(/нацепил/g, 'нацепила')
                .replace(/обрезал/g, 'обрезала')
                .replace(/удалил/g, 'удалила')
                .replace(/собрал/g, 'собрала')
                .replace(/окунул/g, 'окунула')
                .replace(/провёл/g, 'провела')
                .replace(/ввёл/g, 'ввела')
                .replace(/нащупал/g, 'нащупала')
                .replace(/извлёк/g, 'извлекла')
                .replace(/продвинул/g, 'продвинула')
                .replace(/раздвинул/g, 'раздвинула')
                .replace(/захватил/g, 'захватила')
                .replace(/обмакнул/g, 'обмакнула')
                .replace(/выбросив/g, 'выбросив')
                .replace(/заправил/g, 'заправила')
                .replace(/вколол/g, 'вколола')
                .replace(/подключил/g, 'подключила')
                .replace(/отрезал/g, 'отрезала')
                .replace(/прихватил/g, 'прихватила')
                .replace(/отключил/g, 'отключила')
                .replace(/направил/g, 'направила')
                .replace(/установил/g, 'установила')
                .replace(/придвинул/g, 'придвинула')
                .replace(/смочил/g, 'смочила')
                .replace(/наклеил/g, 'наклеила')
                ...
                .replace(/смотрит/g, 'смотрит')
                .replace(/щупает/g, 'щупает')
                .replace(/вправляет/g, 'вправляет')
                .replace(/несет/g, 'несет')
                .replace(/протянул/g, 'протянула')
                .replace(/надевает/g, 'надевает')
                .replace(/завязывает/g, 'завязывает')
                .replace(/проверяет/g, 'проверяет')
                .replace(/выделяет/g, 'выделяет')
                .replace(/сшивает/g, 'сшивает')
                .replace(/обрабатывает/g, 'обрабатывает')
                .replace(/бинтовать/g, 'бинтовать');
        }
        return text;
    };
    ...
    const getAdaptedContent = () => {
        const adapted: typeof operationsContent = {} as typeof operationsContent;
        Object.keys(operationsContent).forEach((key) => {
            adapted[key as keyof typeof operationsContent] = operationsContent[key as keyof typeof operationsContent].map(adaptTextForGender);
        });
        return adapted;
    };
                ...
                <div className="space-y-3 mt-4">
                    {operationsList.map((operation) => (
                        <DropdownMenu
                            ...
                            items={adaptedContent[operation as keyof typeof operationsContent] || ["Содержание будет добавлено позже"]}
                            who="ms"
                        />
                    ))}
                </div>
