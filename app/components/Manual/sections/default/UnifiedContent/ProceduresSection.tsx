...
const ProceduresSection: React.FC<ProceduresSectionProps> = ({ gender }) => {
    ...
    // Функция для адаптации текста под пол пациента
    const adaptTextForGender = (text: string): string => {
        if (gender === 'female') {
            return text
                .replace(/пациента/g, 'пациентку')
                .replace(/пациенту/g, 'пациентке')
                .replace(/пациент /g, 'пациентка ')
                .replace(/больного/g, 'больной')
                .replace(/больному/g, 'больной')
                .replace(/пострадавшего/g, 'пострадавшей')
                .replace(/человека/g, 'человека')
                .replace(/человеку/g, 'человеку')
                .replace(/надел/g, 'надела')
                .replace(/взял/g, 'взяла')
                .replace(/сделал/g, 'сделала')
                .replace(/отложил/g, 'отложила')
                ...
                .replace(/поднял/g, 'подняла')
                .replace(/обнаружил/g, 'обнаружила')
                .replace(/приклеил/g, 'приклеила')
                .replace(/повесил/g, 'повесила')
                .replace(/подкатил/g, 'подкатила')
                .replace(/поставил/g, 'поставила')
                .replace(/продел/g, 'продела')
                .replace(/начал/g, 'начала')
                .replace(/закрыл/g, 'закрыла')
                .replace(/завязал/g, 'завязала')
                .replace(/помазал/g, 'помазала')
                .replace(/уколол/g, 'укололa')
                .replace(/приложил/g, 'приложила')
                .replace(/вытянул/g, 'вытянула')
                .replace(/вылил/g, 'вылила')
                .replace(/сняв/g, 'сняв')
                .replace(/ввёл/g, 'ввела')
                .replace(/повернул/g, 'повернула')
                .replace(/убрав/g, 'убрав')
                .replace(/ввёл/g, 'ввела')
                .replace(/нащупал/g, 'нащупала')
                .replace(/затянул/g, 'затянула')
                .replace(/осмотрел/g, 'осмотрела')
                .replace(/заполнил/g, 'заполнила')
                .replace(/вколол/g, 'вколола')
                .replace(/зашивать/g, 'зашивать')
                .replace(/обрезал/g, 'обрезала')
                .replace(/смочил/g, 'смочила')
                .replace(/обработал/g, 'обработала')
                .replace(/перевязал/g, 'перевязала')
                .replace(/поднес/g, 'поднесла')
                .replace(/нащупать/g, 'нащупать')
                .replace(/запрокинул/g, 'запрокинула')
                .replace(/разорвал/g, 'разорвала')
                .replace(/делать/g, 'делать')
                .replace(/сняв/g, 'сняв')
                .replace(/вставил/g, 'вставила')
                .replace(/взглянул/g, 'взглянула')
                .replace(/пролистал/g, 'пролистала')
                .replace(/нанёс/g, 'нанесла')
                .replace(/растёр/g, 'растерла')
                .replace(/натянул/g, 'натянула')
                .replace(/достает/g, 'достает')
                .replace(/открывает/g, 'открывает')
                .replace(/наполняет/g, 'наполняет')
                .replace(/опускает/g, 'опускает')
                .replace(/накладывает/g, 'накладывает')
                .replace(/формирует/g, 'формирует')
                .replace(/берет/g, 'берет')
                .replace(/укрепляет/g, 'укрепляет')
                .replace(/бросил/g, 'бросила')
                .replace(/передал/g, 'передала')
                .replace(/перекинул/g, 'перекинула')
                .replace(/вытащил/g, 'вытащила')
                .replace(/убрал/g, 'убрала')
                .replace(/распечатал/g, 'распечатала')
                .replace(/установил/g, 'установила')
                .replace(/продемонстрировал/g, 'продемонстрировала')
                .replace(/распечатав/g, 'распечатав')
                .replace(/выкинул/g, 'выкинула')
                .replace(/поднес/g, 'поднесла')
                .replace(/проткнул/g, 'проткнула')
                .replace(/собирать/g, 'собирать')
                .replace(/прижал/g, 'прижала')
                .replace(/достав/g, 'достав')
                .replace(/посмотрел/g, 'посмотрела')
                .replace(/потянулся/g, 'потянулась')
                .replace(/наложил/g, 'наложила')
                .replace(/выкатывает/g, 'выкатывает')
                .replace(/включает/g, 'включает')
                .replace(/наклоняет/g, 'наклоняет')
                .replace(/запускает/g, 'запускает')
                .replace(/вынимает/g, 'вынимает')
                .replace(/повернул/g, 'повернула')
                .replace(/рассматривает/g, 'рассматривает')
                .replace(/протянул/g, 'протянула')
                .replace(/посветил/g, 'посветила')
                .replace(/подложил/g, 'подложила')
                .replace(/набрал/g, 'набрала')
                .replace(/выдавил/g, 'выдавила')
                .replace(/растёр/g, 'растерла')
                .replace(/поводил/g, 'поводила')
                .replace(/изучил/g, 'изучила')
                .replace(/закончил/g, 'закончила')
                .replace(/протрите/g, 'протрите')
                .replace(/прикрепив/g, 'прикрепив')
                .replace(/вложил/g, 'вложила')
                .replace(/пододвинул/g, 'пододвинула')
                .replace(/обезжирил/g, 'обезжирила')
                .replace(/смазал/g, 'смазала')
                .replace(/поставив/g, 'поставив')
                .replace(/прикрепил/g, 'прикрепила')
                .replace(/подключил/g, 'подключила')
                .replace(/запустил/g, 'запустила')
                .replace(/остановил/g, 'остановила')
                .replace(/изучил/g, 'изучила')
                .replace(/поставил/g, 'поставила')
                .replace(/обработал/g, 'обработала')
                .replace(/приклеил/g, 'приклеила')
                .replace(/присоединил/g, 'присоединила')
                .replace(/взглянул/g, 'взглянула')
                .replace(/изучает/g, 'изучает')
                .replace(/отодвинул/g, 'отодвинула')
                .replace(/ставит/g, 'ставит');
        }
        return text;
    };
    ...
    const getAdaptedContent = () => {
        const adapted: typeof proceduresContent = {} as typeof proceduresContent;
        Object.keys(proceduresContent).forEach((key) => {
            adapted[key as keyof typeof proceduresContent] = proceduresContent[key as keyof typeof proceduresContent].map(adaptTextForGender);
        });
        return adapted;
    };
                ...
                <div className="space-y-3 mt-4">
                    {proceduresList.map((procedure) => (
                        <DropdownMenu
                            ...
                            items={adaptedContent[procedure as keyof typeof proceduresContent] || ["Содержание будет добавлено позже"]}
                            who="ms"
                        />
                    ))}
                </div>
