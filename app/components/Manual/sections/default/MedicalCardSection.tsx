  ...
  return (
    <>
      ...
      <div className="subsection">
        ...
        <div className="note">
            <strong>📌 Примечание:</strong> Ждем отыгровки от гражданина.
        </div>
        ...
        <div className="note">
            <strong>📌 Примечание:</strong> Ждем несоклько секунд.
        </div>
        ...
        <ExamplePhrase text={adaptText("me взял заполненную медкарту")} />
