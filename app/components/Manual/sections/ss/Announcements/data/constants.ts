...
export const CITIES: CityOption[] = [
  {
    value: "privolzhsk",
    label: "Приволжск",
    hospital: "Центральная Городская Больница",
    hospitalGen: "Центральной Городской Больницы",
  },
  {
    value: "mirny",
    label: "Мирный",
    hospital: "Областная Клиническая Больница",
    hospitalGen: "Областной Клинической Больницы",
  },
  {
    value: "nevsky",
    label: "Невский",
