...
Sergey_Berg принят в Медицинский Университет ОКБ г. Мирный по результатам открытого собеседования на должность Интерна. Желаем успешного продвижения в работе!  

Состояние на данный момент:  УП - {0/5}; П - (0/5); В - [0/3]`,
...
Сотрудник Sergey_Berg назначена на должность «Заместитель начальник главного военно-медицинского управления».`,
...
Сотрудник Sergey_Berg назначена на должность «Командир военно-медицинским отделом».`,
      tags: ["Командир", "ГВ-МУ"]
    },
    {
      id: "snyatie-vrio",
...
Сотрудник Sergey_Berg переводится из организации Областной Клинической Больницы города Мирный в Центральную Городскую Больницу города Приволжск на должность «Врач-терапевт». Заявление приложено на государственном портале Министерства Здравоохранения. 
 
Текущее положение: УП - {0/5}; П - (1/5); В - [0/3].`,
      tags: ["Перевод"]
    },
    {
      id: "snyatie-vrio",
...
ВрИО срок 7 дней.`,
      tags: ["Назначение", "Зав", "Заместитель"]
    },
    {
      id: "naznachenie-zam",
...
Сотрудник Sergey_Berg назначен на должность «Заместитель Начальник санитарной авиации».`,
      tags: ["Назначение", "СА"]
    },
    {
...
На основании поданного рапорта и в соответствии с кадровыми процедурами, сотрудник Sergey_Berg переводится в отдел Санитарной Авиации на должность Фельдшер Санитарной Авиации. Желаем успехов, продуктивной работы и роста в новых обязанностях!`,
      tags: ["Перевод", "СА", "ФСА" ]
    },
    {
      id: "vostanovlenie-ss",
...
Sergey_Berg восстановлен в Старший состав Областной  Клинической Больницы города Мирный на Заведующего Отделением Лабораторной Диагностики по результатам закрытого собеседования и снова готов приступить к своим обязанностям с новыми силами. Рады видеть вас снова!
