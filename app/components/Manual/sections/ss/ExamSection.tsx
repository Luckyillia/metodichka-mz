    ...
    return (
        <>
            ...
            <div className="subsection">
                ...
                <div className="note">
                    <strong>📸 Примечание:</strong> /timestamp + screen (F12)
                </div>
                <ExamplePhrase text="say Вы сейчас находитесь в больнице ОКБ города Мирный." type="ss" />
                <div className="note">
                    <strong>📌 Примечание:</strong> Ваш тег — [ММУ]
                </div>
                ...
                <div className="note">
                    <strong>📌 Примечание:</strong> Выставлять отметки можно с 4 ранга («Врач-стажёр»). Выдавать медицинские карты можно с 5 ранга («Врач-участковый»).
                </div>
                <ExamplePhrase text="say Интернам запрещено брать РСМП и АСМП." type="ss" />
                <div className="note">
                    <strong>📌 Примечание:</strong> АСМП — Автомобиль Скорой Медицинской Помощи (белый; используется для патрулей, постов и тому подобного). РСМП — автомобиль Реанимационной Скорой Медицинской Помощи (жёлтый; используется для обработки вызовов).
                </div>
            ...
            <div className="subsection">
                ...
                <div className="note">
                    <strong>📸 Примечание:</strong> screen (F12) + /timestamp
                </div>
                <div className="note">
